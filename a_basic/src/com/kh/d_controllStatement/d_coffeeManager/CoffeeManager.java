				...
				if(inputCode == 1) {
					...
					//안전재고를 확인
						...
						if(americanoStock < americanoSaftyStock) {
							System.out.println(" * 재고가 부족해 안전재고를 확보합니다.");
							...
							if(balance > needMoney) {
								...
								System.out.println(" * 잔고가 부족해 안전재고 확보에 실패하였습니다.");
							}
						}
					...
					//안전재고를 확인
						...
						if(mocaStock < mocaSaftyStock) {
							...
							int needMoney = mocaSaftyStock * 2 * mocaCost;
							...
							if(balance > needMoney) {
								...
								System.out.println(" * 잔고가 부족해 안전재고를 확보하지 못했습니다.");
							}
						}
				}else if(inputCode == 3) {
					...
					//안전재고를 확인
						...
						if(latteStock < latteSaftyStock) {
							...
							int needMoney = latteSaftyStock * 2 * latteCost;
