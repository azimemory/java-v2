...
public class Run {
	public static void main(String[] args) {
		...
		System.out.println("1. Map에 데이터를 추가");
		...
		System.out.println("2. Map에 추가한 데이터 중 Key값이 \"백산예술대상\"인 데이터를 출력");
		...
		System.out.println("3. Map안에 저장된 데이터의 개수를 확인");		
		System.out.println("map에 저장된 데이터의 개수 :  " + map.size());
		
		
		System.out.println("=================================");
		
		System.out.println("4. Map에 저장된 데이터를 수정(위의 주석 확인!)");
		map.put("연예대상",new Music("아이유","너랑나"));
		System.out.println(map.get("연예대상"));
		
		System.out.println("=================================");
		
		System.out.println("5. 키값이 \"연예대상\" 인 데이터 삭제");
		map.remove("연예대상");
